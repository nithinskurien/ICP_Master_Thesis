...
# THIS (ONCE)------------------------------------
# meas = me.Measurement(n_v, n_f, 0.5, True)

# OR THIS-------------------------------------

name = '2_3_0.01_0.0001_0.0001.pickle'
with open('/home/tomek/TheTitans/ICP/Pickles/measurement' + name, 'rb') as input:
...
with open('/home/tomek/TheTitans/ICP/Pickles/measurement' + str(n_v) + '_' + str(n_f) + '_' + str(meas.vehicle(0, 0).get_cov()[0,0]) + '_' +
