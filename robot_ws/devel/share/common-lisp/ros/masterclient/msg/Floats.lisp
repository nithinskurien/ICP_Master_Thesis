...
(cl:in-package masterclient-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name masterclient-msg:<Floats> is deprecated: use masterclient-msg:Floats instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Floats>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader masterclient-msg:data-val is deprecated.  Use masterclient-msg:data instead.")
  (data m))
