...
(cl:defmethod cl:initialize-instance :after ((m <GetCoord-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCoord-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name masterclient-srv:<GetCoord-request> is deprecated: use masterclient-srv:GetCoord-request instead.")))
...
(cl:defclass <GetCoord-response> (roslisp-msg-protocol:ros-message)
  ((data
    :reader data
    :initarg :data
    :type masterclient-msg:Floats
    :initform (cl:make-instance 'masterclient-msg:Floats)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GetCoord-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCoord-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name masterclient-srv:<GetCoord-response> is deprecated: use masterclient-srv:GetCoord-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GetCoord-response>)))
  ...
  (cl:format cl:nil "Floats data~%~%~%================================================================================~%MSG: masterclient/Floats~%float32[] data~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GetCoord-response)))
  "Returns full string definition for message of type 'GetCoord-response"
  (cl:format cl:nil "Floats data~%~%~%================================================================================~%MSG: masterclient/Floats~%float32[] data~%~%~%"))
