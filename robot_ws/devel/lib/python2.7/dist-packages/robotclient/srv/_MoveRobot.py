...
"""autogenerated by genpy from robotclient/MoveRobotRequest.msg. Do not edit."""
import sys
...
class MoveRobotRequest(genpy.Message):
  _md5sum = "a67ae5be9f180b7bd9038cd515fe45c1"
  _type = "robotclient/MoveRobotRequest"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """float64 length
"""
  __slots__ = ['length']
  _slot_types = ['float64']
...
def _get_struct_d():
    ...
    return _struct_d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from robotclient/MoveRobotResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class MoveRobotResponse(genpy.Message):
  ...
  _type = "robotclient/MoveRobotResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """int8 ack
...
class MoveRobot(object):
  _type          = 'robotclient/MoveRobot'
  _md5sum = '73d983cb94f147797fb40bd0af7e75a5'
